        ...
        if (buildings.length > 0) {
            ...
            buildings.forEach((item) => {
				...
				if (itemStatus) {
					...
					itemStatus = (item.FullTile) ? Locale.compose("LOC_PLOT_MOD_TCS_FULL_TILE") : undefined;
				}
				...
				const toolTipBuildingIconCSS = UI.getIconCSS(item.Info.ConstructibleType, "CONSTRUCTIBLE");
